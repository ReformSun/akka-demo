...
import com.test.rpc.inter.FencedMainThreadExecutable;
import com.test.rpc.inter.FencedRpcGateway;
 ...
 * with the {@link}. The fencing is done by wrapping all messages in a {@link FencedMessage}.
 *
